...
import logo from "@/assets/talker-flow-logo.png";
...
const Hero = () => {
  ...
  const messages = [
    ...
    {
      sender: "agent",
      text: `Olá! Tudo bem? Eu sou a Isabela, aqui da Integral Care.\nÉ a sua primeira consulta com a gente?`,
      time: "14:01",
    },
    {
      sender: "client",
      text: "Sim, primeira vez. Tem horário pra sexta?",
      time: "14:01",
    },
    {
      sender: "agent",
      text: "Legal! Tenho horário com o Dr. Paulo na sexta às 16h ou 17:15. Qual horário prefere? :)",
      time: "14:02",
    },
    {
      sender: "client",
      ...
      time: "14:02",
      audio: true,
      audioSrc: "/sample/Sample_Audio_Whatsapp.mp3",
    },
    {
      sender: "agent",
      text: "Sim, sexta é uma correria mesmo Marcela! Vamos de manhã, tenho na terça às 9h ou 11:15h. Qual fica melhor?",
      time: "14:03",
    },
    { sender: "client", text: "11:15 fica bom", time: "14:03" },
    {
      sender: "agent",
      text: "Fechado! Me manda seu nome completo por favor, e o seu email tb",
      time: "14:04",
    },
    {
      sender: "client",
      text: "Marcela da Silva\nnm.silva@gmail.com",
      time: "14:04",
    },
    {
      sender: "agent",
      text: "Fechado Marcela, já coloquei na agenda do Dr.!",
      time: "14:05",
    },
    {
      sender: "agent",
    ...
    >
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          {/* --- Texto e CTAs --- */}
          <div>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-center mb-6 leading-tight">
              <span className="text-foreground">Secretária virtual 24h no </span>
              <span className="text-primary">WhatsApp</span>
              <span className="text-foreground"> para vender e atender </span>
              <span className="text-secondary">sem parar</span>
            </h1>
            <p className="text-lg md:text-xl text-center text-muted-foreground max-w-3xl mx-auto mb-10 leading-relaxed">
              Respostas imediatas, linguagem humana e qualificação de leads — sua
              secretária virtual atende cada conversa, agenda oportunidades e
              mantém seu negócio ativo{" "}
              <strong className="text-foreground">24 horas por dia</strong>.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <div className="flex items-center justify-center gap-3 bg-card/80 backdrop-blur-sm px-6 py-4 rounded-xl shadow-soft border border-border/50">
              ...
              <div className="flex items-center justify-center gap-3 bg-card/80 backdrop-blur-sm px-6 py-4 rounded-xl shadow-soft border border-border/50">
                <Calendar className="text-accent w-6 h-6 flex-shrink-0" />
                <span className="font-ui font-semibold text-sm md:text-base">
          ...
          <div className="flex justify-center animate-fade-in">
            <div className="relative mx-auto border-gray-800 bg-black border-[14px] rounded-[2.5rem] h-[540px] w-[260px] md:h-[640px] md:w-[310px] shadow-xl overflow-hidden">
              {/* Top bar */}
                ...
                <div className="flex items-center">
                  <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center overflow-hidden">
                    <img
                      ...
                      onError={(e) =>
                        (e.currentTarget.src =
                          "https://placehold.co/40x40/E0E0E0/757575?text=?")
                      }
                    />
                  </div>
                  <div className="ml-3">
              ...
              <div className="flex flex-col h-[calc(100%-100px)] bg-[#ece5dd]">
                ...
                >
                  {messages.map((msg, index) => (
                    <div
                      key={index}
                      className={`px-3 py-1.5 rounded-lg max-w-[80%] shadow-sm whitespace-pre-line ${
                        msg.sender === "client"
                          ? "bg-white rounded-tl-none self-start"
                          : "bg-[#d9fdd3] rounded-tr-none self-end ml-auto"
                      }`}
                    >
                      {msg.audio && msg.audioSrc ? (
                        <div
                          className="flex items-center gap-2 bg-gray-100 rounded-full px-3 py-1.5 cursor-pointer"
                          onClick={toggleAudio}
                        >
                          {isPlaying ? (
